		...
		<div class="container">
			...
			<div class="holder">
				...
				<form class="insert" action="daten.php" method="post">
					<input type="text" placeholder="Nr" name="id" size="3" /><br/>
					<textarea name="navigation"></textarea><br/>
				...
				<?php
					...
					$ergebnis = mysqli_query($link ,'SELECT * FROM navigation');
					...
					while($ds = mysqli_fetch_assoc($ergebnis)){
						$html = '<form class="update" action="daten.php" method="post">
							...
							Nr. '.$ds['id'].'
							<textarea name="navigation">'.$ds['navigation'].'</textarea>
